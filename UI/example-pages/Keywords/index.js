...
export default class Keywords extends React.Component {
  ...
  componentWillUpdate() {
    ...
    if (global_topic_num == 'all') {
      ...
      global_top_salient_terms = util.httpGet(
        'http://3.34.114.152:5004/topic_relevance?topic=' +
          global_topic_num +
          '&lambda=' +
              ...
              <div className="line-height-sm text-center ml-4">
                ...
                <b className="font-size-lg text-warning">
                  ...
                  <Button
                    ...
                    value={this.keyword_top[this.num_id-1]}>
                    <b id={'keyword' + this.id}>
                      {this.keyword_top[this.num_id-1]}{' '}
                    </b>
              ...
              <div className="flex-grow-1">
                <div className="miniBar">
                  <div
                    ...
                    id={'total-freq' + this.id}
                    style={this.style['total' + this.id]}></div>
                  <div
                    className="miniBarProgress"
                    id={'freq1'}
                    style={this.style['freq' + this.id]}></div>
                </div>
              </div>
            </div>
            <h3 className="title">
              <p className="title_card" id={'title' + this.id}></p>
            </h3>
            <div
              className="p-4-4-4"
              id={'document' + this.id + '1'}
              onClick={this.handleClickSummary(this.id, '1')}></div>
            <div
              className="p-4-4-4"
              id={'document' + this.id + '2'}
              onClick={this.handleClickSummary(this.id, '2')}></div>
            <div
              className="p-4-4-4"
              id={'document' + this.id + '3'}
              onClick={this.handleClickSummary(this.id, '3')}></div>
            <div
              className="p-4-4-4"
              id={'document' + this.id + '4'}
              onClick={this.handleClickSummary(this.id, '4')}></div>
            <div
              className="p-4-4-4"
              id={'document' + this.id + '5'}
              onClick={this.handleClickSummary(this.id, '5')}></div>
          </ListItem>
          <ListItem className="d-block">
            <div className="align-box-row">
              <div className="line-height-sm text-center ml-4">
