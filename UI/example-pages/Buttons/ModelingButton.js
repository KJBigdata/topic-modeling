...
const apiURL = "http://3.34.114.152:5002";
...
class ModelingButton extends React.Component {
    ...
    _post = () => {
        return fetch(`${apiURL}/model`, {
            ...
            window.location.href = 'http://3.34.114.152:3001/carolina-react-admin-dashboard-material-ui-free/Cards3';
        })
    ...
    render() {
        ...
        return (
            <div>
                ...
                {
                    (((this.state.model == 'READY')||(this.state.docs == true)) ?
