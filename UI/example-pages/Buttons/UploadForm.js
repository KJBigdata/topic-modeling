  ...
  customFormRenderer(onSubmit) {
    ...
    return (
      <form id='customForm' style={{ marginBottom: '15px' }}>
        <input style={{ display: 'block' }} type="file" name='file' id="InputFile" />
        <div style={styles.bsHelp}>It must be TSV file.</div>
  ...
  render() {
    ...
    return (
      <div>
        ...
        <FileUploadProgress key='file' url='http://3.34.114.152:5006/upload' method='post'
